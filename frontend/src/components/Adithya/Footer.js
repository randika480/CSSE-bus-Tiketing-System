...
const Footer = () => {
  const footer = {
    ...
    footerSitemapLinks: [
      ...
      { labelName: "Newsletter", path: "/#" },
      { labelName: "Offers", path: "/#" },
      ...
      >
          ...
          <div>
            ...
            <Grid item xs={12} sm={11} md={6}>
              <div className=" font-contentFont text-sm text-gray-500">
                ...
                through two decades of an energy crisis without an effective
                energy policy. Because of an easy and thoughtless reliance on
                imported oil, we have no adequate policy for the conservation of
                gasoline and other petroleum products. We have no adequate
                policy for the development or use of other, less harmful forms
            ...
            <div className="md:ml-4 sm:w-1/4 lg:w-2/5">
              <Link to="/">
                <div className="cursor-pointer inline-block">
                  <img
                    src="https://i.ibb.co/nnWcFxp/puzzle-personal-transport.png"
                    alt="apuru-poth-logo"
                    height="90"
                    width="90"
                  />
        ...
        <Grid item xs={12} md={4}>
          <div className=" font-mono text-sm ">
            Copyright&copy; MATRIX-TRANSPORTS 2021
          </div>
        </Grid>
        <Grid item xs={12} md={5}>
          <div className=" "></div>
